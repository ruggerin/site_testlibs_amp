...
function BeIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="relative flex h-[100svh] w-full flex-col overflow-hidden bg-[var(--orange)]">
        {/* Figma Início — wppr_orange_1.jpg (textura do protótipo) */}
        ...
        <div className="relative z-10 flex min-h-0 flex-1 flex-col">
          ...
          <div
            ...
            style={{ marginTop: "clamp(-80px, -4vw, -30px)" }}
          >
            <svg
              viewBox="0 0 1872 836"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="absolute inset-x-0 top-0 h-full w-full max-h-[calc(100svh-11.25rem)] sm:max-h-[calc(100svh-10.5rem)] md:max-h-[calc(100svh-9.75rem)]"
            ...
            >
              ...
              <foreignObject x="0" y="0" width="1872" height="836" clipPath="url(#anos-clip)">
                ...
                >
                  <source
                    src="/assets/COMPILADO-WEBM0001-1210.webm"
                    type="video/webm"
                  />
                </video>
              </foreignObject>
          ...
          {/* Rodapé — Figma 2:192 (Inter 20px, #232323, ícones com borda 2px) */}
          <footer
            className="relative z-10 shrink-0 px-6 pb-5 pt-1 md:px-6 md:pb-6"
            style={{ fontFamily: "var(--font-inter)" }}
          >
            <div className="relative mx-auto max-w-[1872px]">
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between md:gap-3">
                <p className="text-[11px] leading-snug text-[#232323] md:text-[20px] md:leading-[1.21]">
                  Agência AMP ® {new Date().getFullYear()}
                  <br />
                  Todos os direitos reservados.
                </p>

                <p className="pointer-events-none hidden text-center text-[20px] leading-[1.21] text-[#232323] lg:absolute lg:left-1/2 lg:top-1/2 lg:block lg:w-[min(390px,40vw)] lg:-translate-x-1/2 lg:-translate-y-1/2">
                  Rua Andrea Limongi, N16 - Parque Dez de Novembro | Manaus - AM
                </p>

                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between md:justify-end md:gap-8">
                  <div className="flex gap-3 sm:gap-4">
                    {FOOTER_SOCIAL.map(({ label, Icon, href }) => (
                      <a
                        ...
                        aria-label={label}
                        className="flex size-10 items-center justify-center border-2 border-[#232323] text-[#232323] transition-opacity hover:opacity-75 md:size-[47px]"
                      >
                  ...
                  <div className="text-left text-[11px] text-[#232323] md:text-right md:text-[20px] md:leading-[1.21]">
                    <span className="block">Fale conosco</span>
                    <a href={SITE.phoneHref} className="transition-opacity hover:opacity-75">
                      {SITE.phone}
                    </a>
                  </div>
                </div>
              ...
              <p className="mt-3 text-center text-[11px] leading-snug text-[#232323] lg:hidden">
                Rua Andrea Limongi, N16 - Parque Dez de Novembro | Manaus - AM
              </p>
            </div>
          </footer>
